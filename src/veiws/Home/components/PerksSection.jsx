  ...
  return (
    <div className='grid grid-cols-12 justify-items-center px-1 md:px-24 lg:px-64 pt-20 gap-6'>
        ...
        <div className="col-span-12 ">
                <div className="my-10 h-full grid gap-8 sm:mt-16 lg:grid-cols-3 lg:grid-rows-3">
                    ...
                    <div className="flex gap-8 flex-col justify-between lg:row-span-3 row-start-1 col-start-2 h-full  ">
        ...
        <div className="flex gap-8 w-full col-span-12 mt-10 pt-8">
            <div className="text-white relative py-8 px-8 sm:pt-8 flex flex-row rounded-[calc(theme(borderRadius.lg)+1px)] bg-gradient-to-br from-[#FD6BA8] to-[#5E9CFF] rounded-3xl w-full ">
                {/* <div className=" relative py-8 px-8 sm:pt-8 flex flex-row rounded-[calc(theme(borderRadius.lg)+1px)]"> */}
                        <div className="w-[65%]">
                            <p className=" text-4xl font-semibold tracking-tight text-gray-950 max-lg:text-center">Rock-Solid Compliance</p>
                            <p className="mt-2 max-w-lg font-base text-lg text-sm/6 max-lg:text-center tracking-wide">
                        ...
                        <div className="absolute h-full bottom-2 top-2 right-0">
                            <img
            ...
            <div className="bg-gradient-to-b from-[#8A70B0] to-[#482084] rounded-3xl w-full overflow-hidden ">
                <div className="h-full text-white relative py-8 px-8 sm:pt-8  flex flex-row flex-row-reverse text-end rounded-[calc(theme(borderRadius.lg)+1px)]">
                    <div className="w-[65%]">
                        <p className=" text-4xl font-semibold tracking-tight text-gray-950 max-lg:text-center">Cloud-Powered Savings</p>
                        <p className="mt-2 max-w-lg font-base text-lg text-sm/6 max-lg:text-center tracking-wide">
                        Centralize people management with one HR software. Save time and cut costs by leveraging cloud technology.                         </p>
                    </div>
                    <div className="absolute h-full bottom-0 top-1 left-0 ">
                        <img
                            className="h-full size-full object-cover object-top self-end"
                            src={gridImage5}
                            alt=""
