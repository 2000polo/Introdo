...
const HeroSection = () => {
  ...
  return (
    <div className="grid grid-cols-12 justify-items-center px-1 md:px-24 lg:px-64 pt-20 gap-6 ">
        <span class=" col-span-12 w-fit rounded-full py-2 px-6 text-[#FC1777] text-base md:text-lg font-medium me-2 rounded border border-[#FC1777]">EMPOWER EVERY ROLE</span>
        ...
        <div className="place-self-start col-span-10 md:col-span-9">
          <HeroSectionTab tabs={tabs} setCurrentTab={setCurrentTab} currentTab={currentTab} />
        </div>

        <section className='col-span-12 grid gap-5 grid-cols-12 place-items-center mt-8'>
                  ...
                  <div className="md:grid hidden ">
                    {
                      tabs?.map((tab) => {
                        return (
                          ...
                          md:mt-12 p-7 rounded-3xl border-blue-200 border-2 divide-y divide-blue-200`}
